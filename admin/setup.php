...
if($db !== false && db_table_exists($db, "pm_%") === true){
    $installed = true;
    $_SESSION['msg_notice'][] = "It seems that Nesto CMS is already installed. Remove your former tables from your database to reinstall it <a class=\"btn btn-default\" href=\"login.php\">Log in</a>";
}
...
<body class="white">
    <div class="container">
        ...
        if(!$installed){ ?>
            <h1>Welcome</h1>
            <p>Fill fields with your information. It will take only a few seconds. You can always modify these parameters later
